...
--
-- Host: localhost    Database: orna1114_ornasa
-- ------------------------------------------------------
...
CREATE TABLE `acos` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1567 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `aros_acos` (
  ...
  `_create` varchar(2) COLLATE utf8mb4_bin NOT NULL DEFAULT '0',
  `_read` varchar(2) COLLATE utf8mb4_bin NOT NULL DEFAULT '0',
  `_update` varchar(2) COLLATE utf8mb4_bin NOT NULL DEFAULT '0',
  `_delete` varchar(2) COLLATE utf8mb4_bin NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `ARO_ACO_KEY` (`aro_id`,`aco_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3175 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `employees` (
  ...
  `ending_date` date DEFAULT '2030-12-31',
...
CREATE TABLE `exchange_rates` (
  ...
  `conversion_currency_id` int(11) NOT NULL,
...
CREATE TABLE `products` (
  ...
  `product_type_id` int(11) NOT NULL,
  `product_nature_id` int(11) DEFAULT NULL,
  `production_type_id` int(11) DEFAULT NULL,
  `volume_ml_min` int(11) DEFAULT NULL,
  `volume_ml_max` int(11) DEFAULT NULL,
  `weight_g` decimal(10,1) DEFAULT NULL,
  `diameter_mm` int(11) DEFAULT NULL,
  `width_inch` int(11) DEFAULT NULL,
  `length_inch` int(11) DEFAULT NULL,
  `height_inch` int(11) DEFAULT NULL,
  `bag_product_id` int(11) DEFAULT NULL,
  `packaging_unit` int(11) DEFAULT '0',
  `preferred_raw_material_id` int(11) DEFAULT NULL,
  `preferred_weight_g` decimal(11,1) DEFAULT NULL,
  `default_cost` decimal(18,8) NOT NULL DEFAULT '0.00000000',
  `default_cost_currency_id` int(11) NOT NULL DEFAULT '0',
  `bool_active` tinyint(1) NOT NULL DEFAULT '1',
  `preferred_recipe_id` int(11) DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `modified` datetime DEFAULT NULL,
  `accounting_code_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `user_actions` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=118659 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=490221 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  `bool_show_in_list` tinyint(1) NOT NULL DEFAULT '1',
  `bool_view_all_users` tinyint(1) NOT NULL DEFAULT '0',
  `client_id` int(11) NOT NULL DEFAULT '0',
  `bool_test` tinyint(1) NOT NULL DEFAULT '0',
  `created` datetime DEFAULT NULL,
  `modified` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_users_userroles1_idx` (`role_id`)
...
--
-- Dumping events for database 'orna1114_ornasa'
--

--
-- Dumping routines for database 'orna1114_ornasa'
--
/*!50003 DROP PROCEDURE IF EXISTS `sp_inventary` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_inventary`(in productType int,in pdate datetime,in warehouseid INT)
begin 
  select * from (
...
/*!50003 DROP PROCEDURE IF EXISTS `sp_saldo` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_saldo`(in productId int,in pwarehouseId int,in pdate datetime,in prawMaterialId int,in returnv int)
begin
...
if returnv=0 then
 ...
 INSERT INTO temp_resultados (
  ...
  join ( SELECT `StockItemx`.id,max(`StockItemLogx`.id) idx FROM `orna1114_ornasa`.`stock_item_logs` AS `StockItemLogx` 
    join `orna1114_ornasa`.`stock_items` AS `StockItemx` on `StockItemx`.id=`StockItemLogx`.stockitem_id
    join `orna1114_ornasa`.`products` AS `Productox` on `Productox`.id=`StockItemLogx`.`product_id`
  WHERE  `StockItemLogx`.`stockitem_date` <= DATE_ADD(pdate, INTERVAL 0 DAY)  
   and (case when ((`Productox`.product_type_id=11 or `Productox`.product_type_id=9 or `Productox`.product_type_id=18) 
   and `StockItemx`.`stockitem_depletion_date` > pdate) then true  
   when (`Productox`.product_type_id not in(9,11,12,17)) then true else false end)
   -- se omite tipo 9 y 11, ya fueron evaluados en el case y los tipos 12,17 se omiten por estar fijos
...
/*!50013 DEFINER=`orna1114_ornasa`@`190.143.%.%` SQL SECURITY DEFINER */
...
-- Dump completed on 2025-09-30  7:44:17
