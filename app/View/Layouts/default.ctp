...
<head>
    ...
    echo $this->Html->css('bootstrap-grid.min');
		...
		echo $this->Html->css('clientesorn.css');
    echo $this->Html->css('clientesorn_tables.css');
		echo $this->Html->css('clientesorn.print.css',['media' => 'print']);
		if ($currentController == 'orders' && $currentAction== 'imprimirVenta'){
      echo $this->Html->css('clientesorn_invoice.css');  
    }
	...
	<div id="container">
		<div id="header">
          ...
          echo '<div id="headerbar">';
					echo $this->Html->image("clientesorn_logo_small.png", ['alt' => 'Ornasa','url' => $userhomepage,'style'=>'max-width:200px;']);
